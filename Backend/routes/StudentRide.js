...
import StudentRiding, { StudentLogIn, StudentSignUp, StudentLogout, GetCurrentStudent } from '../controllers/StudentProfile.js';
...
StudentRide.post("/ride/studentRide", isAuth, StudentRiding);
