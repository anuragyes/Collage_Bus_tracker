...
const BusManagement = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setShowModal(false);
    setFormData({ busNumber: '', route: '', capacity: '', driver: '', status: 'Active' });
  };
  ...
  useEffect(() => {
    const fetchbuses = async () => {
      try {
        ...
        console.error('Error fetching buses Deatils:', error);
        setloading(false)
      }
    }
    fetchbuses();
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        {buses.map((bus) => (
          <div key={bus.id} className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-800"> BusNo: {bus.busNumber}</h3>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex justify-between">
                <span className="font-medium flex">Capacity:   <span className='  ml-1 pt-0.5'><MdAirlineSeatReclineNormal /></span></span>
                <span>{Capacity} students</span>
              </div>
              <div className="flex justify-between">
                <span className="  flex gap-2 font-medium">Driver: <span className='ml-1 pt-0.5'><FaUser /></span> </span>
                <span>Unknown</span>
              </div>
              ...
              <div className="flex justify-between">
                <span className="font-medium">
                  isAssigned:</span>
                <span className={bus.isAssigned ? "text-green-600 font-semibold" : "text-red-600 font-semibold"}>
