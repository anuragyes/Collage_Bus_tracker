  ...
  return (
    <div className="p-6 md:p-10 bg-gradient-to-br from-gray-50 via-white to-blue-50 min-h-screen">
      ...
      {/* {showModal && (
        ...
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl w-full max-w-md shadow-2xl border border-gray-200">
            <div className="p-6">
              <h2 className="text-xl font-bold text-center text-blue-700 mb-5">Add New Driver</h2>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <FileUploadField label="Aadhaar Card (PDF/Image)" fileType="aadhaar" accept=".pdf,.jpg,.jpeg,.png" />
                <FileUploadField label="Driver License (PDF/Image)" fileType="license" accept=".pdf,.jpg,.jpeg,.png" />
                <FileUploadField label="Driver Photo (Image)" fileType="photo" accept=".jpg,.jpeg,.png" />
