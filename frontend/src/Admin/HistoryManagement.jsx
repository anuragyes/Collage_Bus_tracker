...
const HistoryManagement = () => {
  ...
  const fetchHistory = async () => {
    try {
      ...
      setHistoryData(res.data.allDetails);
    } catch (err) {
                  ...
                  <tbody className="divide-y divide-gray-200/50">
                    {filteredData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-gray-600">{item.phoneNumber}</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  >
                    <div className="space-y-3">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-bold text-lg text-gray-900">{item.driverName}</h3>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="text-gray-800">{item.phoneNumber}</p>
                        </div>
                        <div>
                      ...
                      <div className="border-t border-gray-200 pt-3 space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-gray-800">{new Date(item.loginTime).toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between text-sm">
