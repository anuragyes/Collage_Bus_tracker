...
//     useEffect(() => {
//         if (mapRef.current && currentLocation && isDriving) {
...
//     if (loadError) {
//         return <div className="text-red-500 p-4">Error loading maps. Please check your connection.</div>;
//     }
...
//                         socket.emit("driver_login", { 
//                             busId: user.busNumber,
