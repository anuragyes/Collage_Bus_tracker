...
//   }, [userType, isLogin, showForgotPassword]);
...
//       }
//       toast.success(`${userType} signed up successfully! ✅`);
//       navigate('/');
...
//                 <input
//                   type="text"
//                   placeholder={`${userType.charAt(0).toUpperCase() + userType.slice(1)} Name`}
//                   value={formData.name}
//                   onChange={(e) => updateField("name", e.target.value)}
//                   className={`w-full p-3 border rounded-lg focus:outline-none transition-all ${
//                     errors.name ? "border-red-500 focus:ring-2 focus:ring-red-400" : "focus:ring-2 focus:ring-blue-400"
//                   }`}
//                 />
...
//                   className={`w-full p-3 border rounded-lg focus:outline-none transition-all ${
//                     errors.confirmPassword ? "border-red-500 focus:ring-2 focus:ring-red-400" : "focus:ring-2 focus:ring-blue-400"
//                   }`}
//                 />
